    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _axios.default.patch("".concat(BASE_URL, "/v1/users/updateMe"), {
            name: name,
            email: email
          }, {
            withCredentials: true
